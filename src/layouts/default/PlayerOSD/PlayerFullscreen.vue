    ...
    >
      ...
      <div class="main">
        ...
        <div style="padding-top: 3vh; text-align: center">
            ...
            >
              {{
                `${curQueueItem.media_item.name} ${
                  curQueueItem.media_item.version ? '(' + curQueueItem.media_item.version + ')' : ''
                }`
              }}
            </h1>
          </div>
          ...
          <!-- track: artists(s) -->
          <div
            v-if="activePlayerQueue?.active && curQueueItem && curQueueItem.media_item?.media_type == MediaType.TRACK"
          ...
          <div class="mediacontrols">
            <div class="mediacontrols-top-right">
              ...
              >
                <div>
                  <!-- player control buttons -->
                  <PlayerExtendedControls :responsive-volume-size="true" :show-queue-dialog="true" />
                </div>
              </div>
            </div>
          </div>
