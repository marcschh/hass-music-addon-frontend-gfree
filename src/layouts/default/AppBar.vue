<template>
  <v-app-bar density="compact" style="height: 56px" :elevation="2">
    <template #prepend>
      <v-menu location="bottom end">
        <template>
          <v-btn icon="mdi-playlist-play" variant="plain" @click="store.showNavigationMenu = !store.showNavigationMenu">
    ...
    <v-app-bar-title>
      <span style="cursor: pointer" @click="heading.mainLink">{{ heading.mainTitle }}</span>
      <span v-if="heading.subTitle" style="opacity: 0.5"> | {{ heading.subTitle }}</span>
    </v-app-bar-title>
