...
export class MusicAssistantApi {
  ...
  public getPlayerQueueItems(queue_id: string, chunkCallback?: chunkCallback): Promise<Track[]> {
  ...
  public playerCommandVolumeUp(playerId: string) {
    this.playerCommandVolumeSet(playerId, this.players[playerId].volume_level + 5);
  }
